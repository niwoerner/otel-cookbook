...
const styles = {
  ...
  colors: {
    ...
    blue: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.blue.500)] [--btn-border:theme(colors.blue.600/90%)]",
      "[--btn-icon:theme(colors.blue.300)] data-[active]:[--btn-icon:theme(colors.blue.200)] data-[hover]:[--btn-icon:theme(colors.blue.200)]",
    ],
    cyan: [
